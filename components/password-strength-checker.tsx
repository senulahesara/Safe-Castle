...
const PasswordStrengthChecker: React.FC = () => {
    ...
    const score = strengthResult ? strengthResult.score : -1; // -1 to indicate no score if empty
    const progressValue = password ? (score + 1) * 20 : 0; // 0% if password is empty
    const scoreLabel = password ? strengthLabels[score] : "N/A";
    const badgeClass = password ? badgeBg[score] : "bg-gray-500";
    const progClass = password ? progBg[score] : "bg-gray-500"; // Grey progress bar if empty
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <Card className="shadow-2xl overflow-hidden bg-black">
                    <div className="md:flex flex-col md:flex-row">
                        ...
                        <div className="md:w-1/2 p-6 md:p-10 bg-black order-first md:order-none"> {/* Added order-first for mobile */}
                            <div className="max-w-xl mx-auto">
                                ...
                                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                                    <Button variant="outline" className="flex-1" onClick={() => generateStrongPassword(20)}>
                                ...
                                {breachCount !== null && breachCount > 0 && (
                                    <div className="mt-6">
                                        ...
                                        <div className="mt-2 p-3 bg-red-900/50 rounded-md text-sm text-red-300">
                                            ...
                                            <span className="font-bold">This password has been breached {breachCount.toLocaleString()} times!</span>
                        ...
                        <div className="md:w-1/2 bg-black p-6 md:p-8 border-t md:border-t-0 md:border-l md:border-gray-700 md:order-last"> {/* Added md:order-last for mobile */}
                            {/* Strength header */}
                                    ...
                                    {breachLoading ? (
                                        ...
                                        <div className="flex items-start space-x-2 text-red-500">
                                            ...
                                            <p className="text-base font-semibold">
                                                Password breached {breachCount.toLocaleString()} times — avoid using this password.
                                            </p>
                                            {breachDetails.length > 0 && (
                                                <div className="mt-2">
                                                    <p className="font-semibold text-sm">Possible breaches:</p>
